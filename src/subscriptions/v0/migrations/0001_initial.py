            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(0, "Pending"), (1, "Preauth"), (2, "Completed"), (3, "Canceled"), (4, "Error")],
                        default=0,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="usages",
                        to="subscriptions_v0.resource",
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="usages", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
