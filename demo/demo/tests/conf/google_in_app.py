...
from subscriptions.providers.google_in_app.models import GoogleAcknowledgementState, GoogleAutoRenewingPlan, GoogleOfferDetails, GoogleSubscription, GoogleSubscriptionNotificationType, GoogleSubscriptionPurchase, GoogleSubscriptionPurchaseLineItem, GoogleSubscriptionPurchaseV2, GoogleSubscriptionState
...
@pytest.fixture
def google_subscription_purchase(now, plan_with_google) -> GoogleSubscriptionPurchase:
    return GoogleSubscriptionPurchase(
        autoRenewing=True,
        priceCurrencyCode=str(plan_with_google.charge_amount.currency),
        priceAmountMicros=str(int(plan_with_google.charge_amount.amount * 1_000_000))
    )


@pytest.fixture
def google_subscription_purchase_v2(now, google_plan_id) -> GoogleSubscriptionPurchaseV2:
...
@pytest.fixture
def google_in_app__subscription_purchase_v2_dict(google_in_app) -> dict:
    return {
